...
export default class ToDosList extends Component {
  ...
  editTodo = () => {
    ...
    axios
      .post(`/todos/update/${this.state.id}`, this.state)
      .then((response) => {
        ...
        this.setState({
          ...
          toastbody: "Todo edited and saved Successully",
        });
      })
      .catch((error) => {
        this.setState({
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({
          ...
          showToast: true,
          toastHeading: "Success!",
          toastbody: "Todo added Successully",
        });
      })
      .catch((error) => {
        this.setState({
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({
          ...
          showToast: true,
          toastHeading: "Success!",
          toastbody: "Todo deleted Successully",
        });
      })
      .catch((error) => {
        this.setState({
    ...
    return (
      <div className="mainbody">
        <Toast
          ...
          heading={this.state.toastHeading}
